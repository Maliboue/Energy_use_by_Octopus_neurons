...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 6, 0);
 	...
 	ivoc_help("help ?1 ih /Users/lampochka/Desktop/GitHub/Diploma/RM03_model/x86_64/ih.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double _zrexp ;
 static double _zq10 ;
...
static int  rates (  double _lv ) {
   ...
   rinf = 1.0 / ( 1.0 + exp ( ( _lv + 76.0 ) / 7.0 ) ) ;
   rtau = ( 100000.0 / ( 237.0 * exp ( ( _lv + 60.0 ) / 12.0 ) + 17.0 * exp ( - ( _lv + 60.0 ) / 14.0 ) ) ) + 25.0 ;
    return 0; }
...
static int _ode_count(int _type){ hoc_execerror("ih", "cannot be used with CVODE"); return 0;}
